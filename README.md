...
...    DG1|2||C80.1^Malignant (primary) neoplasm, unspecified^I10|||F'''.lstrip()
>>> msg_2 = '''
...
...     DG1|2||M48.06^Spinal stenosis, lumbar region^I10|||F'''.lstrip()
>>> msgs = [msg_1, msg_2]
>>> 
>>> # ID locations (message fields and/or components to uniquely ID messages)
>>> id_locs = {
...
... }
>>> 
>>> # report locations (message fields and/or components to be reported)
>>> report_locs = {
